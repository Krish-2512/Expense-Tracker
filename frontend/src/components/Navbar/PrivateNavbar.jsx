...
// import { logoutAction } from "../../assets/redux/slice/authSlice";
...
//     localStorage.removeItem('userInfoKey'); // Ensure the key matches exactly

//     // Debugging step to confirm local storage operation
//     if (localStorage.getItem('userInfoKey') === null) {
//       console.log("User info successfully removed from local storage");
//     } else {
//       console.log("Failed to remove user info from local storage");
//     }



//     // You might want to navigate the user to a login page or home page here
//   }
//   return (
            ...
            <div className="flex h-16 justify-start items-center">
              <div className="flex justify-center flex-row w-full">
                ...
                <div className="flex flex-shrink-0 items-center">
                  {/* Logo */}
                  {/* <SiAuthy className="h-8 w-auto text-green-500" /> */}
                  {<img src='logo.png' style={{height:'52px' , width:'50px'}} />}
                </div>
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  <Link
                    to="/"
